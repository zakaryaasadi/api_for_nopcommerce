...
### GET /api/customers/1?fields=id,email,addresses(province,country)
Get a single customer with id 1 and add only the id, the email and add addresses only the province and the country in the response
